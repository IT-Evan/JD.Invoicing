...
namespace JD.Invoicing.Migrations
{
    ...
    [Migration("20190921105544_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JD.Invoicing.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("JD.Invoicing.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("JD.Invoicing.Entitys.PO", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("JD.Invoicing.Entitys.PODetial", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("JD.Invoicing.Entitys.Store", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("OrderOrderID")
                        .HasMaxLength(45);

                    b.Property<int?>("OrderOrder_id");
            ...
            modelBuilder.Entity("JD.Invoicing.Entitys.StoreDetial", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("JD.Invoicing.Authorization.Roles.Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("JD.Invoicing.Authorization.Users.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("JD.Invoicing.Authorization.Roles.Role", b =>
                {
                    b.HasOne("JD.Invoicing.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("JD.Invoicing.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("JD.Invoicing.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
            ...
            modelBuilder.Entity("JD.Invoicing.Entitys.PODetial", b =>
                {
                    b.HasOne("JD.Invoicing.Entitys.PO", "PO")
                        .WithMany("PODetials")
            ...
            modelBuilder.Entity("JD.Invoicing.Entitys.StoreDetial", b =>
                {
                    b.HasOne("JD.Invoicing.Entitys.Store", "PurchaseWarehousing")
                        .WithMany("PurchaseWarehousingMX")
                        .HasForeignKey("Order_id")
                        .OnDelete(DeleteBehavior.Cascade);
                });
