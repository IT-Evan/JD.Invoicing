        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    OrderID = table.Column<string>(maxLength: 45, nullable: true),
                    OrderDate = table.Column<DateTime>(nullable: true),
                    CreateDate = table.Column<DateTime>(nullable: true),
                    CreateName = table.Column<string>(maxLength: 45, nullable: true),
                    CGNameID = table.Column<int>(nullable: false),
                    CGName = table.Column<string>(maxLength: 45, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderID = table.Column<string>(maxLength: 45, nullable: true),
                    OrderDate = table.Column<DateTime>(nullable: true),
                    OrderType = table.Column<string>(maxLength: 10, nullable: true),
                    CreateDate = table.Column<DateTime>(nullable: true),
                    CreateName = table.Column<string>(maxLength: 45, nullable: true),
                    ...
                    SHDate = table.Column<DateTime>(nullable: true),
                    SHName = table.Column<string>(maxLength: 45, nullable: true),
                    OrderOrder_id = table.Column<int>(nullable: true),
                    OrderOrderID = table.Column<string>(maxLength: 45, nullable: true),
                    CreationTime = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PODetial", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PODetial_PO_Order_id",
                        column: x => x.Order_id,
                        principalTable: "PO",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StoreName = table.Column<string>(maxLength: 45, nullable: true),
                    OrderRow = table.Column<int>(nullable: true),
                    Good_id = table.Column<int>(nullable: false),
                    GoodID = table.Column<string>(maxLength: 45, nullable: true),
                    GoodName = table.Column<string>(maxLength: 145, nullable: true),
                    DW = table.Column<string>(maxLength: 45, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StoreDetial", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StoreDetial_Store_Order_id",
                        column: x => x.Order_id,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PODetial_Order_id",
                table: "PODetial",
                column: "Order_id");

            migrationBuilder.CreateIndex(
                name: "IX_StoreDetial_Order_id",
                table: "StoreDetial",
                column: "Order_id");
        }
